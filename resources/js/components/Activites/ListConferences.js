...
const Image= <img style={{height:'150px',width:'150px', borderRadius:'75px'}} src={require('./conf.jpg')} />
      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={row.name} onClick={()=>props.handleChangeIndexPam(1,'le titre tet chaje')} >
